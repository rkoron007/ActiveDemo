...
/***/ "./frontend/components/post_form.jsx":
/*!*******************************************!*\
  !*** ./frontend/components/post_form.jsx ***!
  \*******************************************/
    ...
    _createClass(Form, [{
        ...
        value: function handleFile(e) {
            ...
            fileReader.onloadend = function () {
                ...
                _this2.setState({ photoFile: file, photoUrl: fileReader.result });
            };
            if (file) {
        ...
        value: function handleSubmit(e) {
            ...
            // if we have a photo then append it 
        ...
        value: function render() {
            ...
            var preview = this.state.photoUrl ? _react2.default.createElement('img', { src: this.state.photoUrl }) : null;
...
/***/ "./frontend/components/post_index.jsx":
/*!********************************************!*\
  !*** ./frontend/components/post_index.jsx ***!
  \********************************************/
/*! no static exports found */
    ...
    return _react2.default.createElement(
        ...
        posts.map(function (post) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('img', { src: post.photoUrl })
            );
        })
    );
}
...
var _post_form = __webpack_require__(/*! ./components/post_form */ "./frontend/components/post_form.jsx");

var _post_form2 = _interopRequireDefault(_post_form);

var _post_index = __webpack_require__(/*! ./components/post_index */ "./frontend/components/post_index.jsx");

var _post_index2 = _interopRequireDefault(_post_index);
    ...
    _createClass(componentName, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(_post_form2.default, { fetchPosts: this.fetchPosts }),
                _react2.default.createElement(_post_index2.default, { posts: this.state.posts })
            );
        }
    }]);
